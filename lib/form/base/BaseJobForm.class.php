...
class BaseJobForm extends BaseFormPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'g_cal_id_custom_url' => new sfWidgetFormInput(),
    ));
    ...
    $this->setValidators(array(
      ...
      'zip'                 => new sfValidatorString(array('max_length' => 8, 'required' => false)),
      ...
      'g_cal_id_custom_url' => new sfValidatorString(array('max_length' => 255, 'required' => false)),
    ));
