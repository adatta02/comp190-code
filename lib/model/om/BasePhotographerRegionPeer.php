...
abstract class BasePhotographerRegionPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'PhotographerId', 'Address', 'Latitude', 'Longitude', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'photographerId', 'address', 'latitude', 'longitude', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::PHOTOGRAPHER_ID, self::ADDRESS, self::LATITUDE, self::LONGITUDE, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'photographer_id', 'address', 'latitude', 'longitude', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'PhotographerId' => 1, 'Address' => 2, 'Latitude' => 3, 'Longitude' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'photographerId' => 1, 'address' => 2, 'latitude' => 3, 'longitude' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::PHOTOGRAPHER_ID => 1, self::ADDRESS => 2, self::LATITUDE => 3, self::LONGITUDE => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'photographer_id' => 1, 'address' => 2, 'latitude' => 3, 'longitude' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
