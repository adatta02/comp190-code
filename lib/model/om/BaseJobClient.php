...
/**
 * Base class that represents a row from the 'job_client' table.
 *
 * 
 *
 ...
 */
abstract class BaseJobClient extends BaseObject  implements Persistent {


  const PEER = 'JobClientPeer';
	...
	/**
	 * Initializes internal state of BaseJobClient object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     JobClient The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = JobClientPeer::ID;
		}
	...
	public function setClientId($v)
	{
		...
		if ($this->client_id !== $v) {
			$this->client_id = $v;
			$this->modifiedColumns[] = JobClientPeer::CLIENT_ID;
		}
	...
	public function setJobId($v)
	{
		...
		if ($this->job_id !== $v) {
			$this->job_id = $v;
			$this->modifiedColumns[] = JobClientPeer::JOB_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 3; // 3 = JobClientPeer::NUM_COLUMNS - JobClientPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating JobClient object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = JobClientPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BaseJobClient:save:pre') as $callable)
    {
      ...
      if (is_int($affectedRows))
      {
		...
		try {
			...
			$con->commit();
    foreach (sfMixer::getCallables('BaseJobClient:save:post') as $callable)
    {
      call_user_func($callable, $this, $con, $affectedRows);
    }

			JobClientPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = JobClientPeer::doInsert($this, $con);
					...
					$affectedRows += JobClientPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = JobClientPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = JobClientPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(JobClientPeer::ID)) $criteria->add(JobClientPeer::ID, $this->id);
		if ($this->isColumnModified(JobClientPeer::CLIENT_ID)) $criteria->add(JobClientPeer::CLIENT_ID, $this->client_id);
		if ($this->isColumnModified(JobClientPeer::JOB_ID)) $criteria->add(JobClientPeer::JOB_ID, $this->job_id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(JobClientPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of JobClient (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     JobClient Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     JobClientPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new JobClientPeer();
		}
		return self::$peer;
	}
  ...
  {
    if (!$callable = sfMixer::getCallable('BaseJobClient:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseJobClient::%s', $method));
    }
