...
abstract class BasePhoto extends BaseObject  implements Persistent {
  ...
  const PEER = 'PhotoPeer';
	...
	public function setJobId($v)
	{
		...
		if ($this->job_id !== $v) {
			$this->job_id = $v;
			$this->modifiedColumns[] = PhotoPeer::JOB_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = PhotoPeer::NUM_COLUMNS - PhotoPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(PhotoPeer::JOB_ID)) $criteria->add(PhotoPeer::JOB_ID, $this->job_id);
