...
abstract class BaseUserPeer {
	...
	public static function doCountJoinUserType(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(UserPeer::USER_TYPE_ID,), array(UserTypePeer::ID,), $join_behavior);
    ...
    foreach (sfMixer::getCallables('BaseUserPeer:doSelectJoin:doSelectJoin') as $callable)
    {
      call_user_func($callable, 'BaseUserPeer', $c, $con);
		...
		$c->addJoin(array(UserPeer::USER_TYPE_ID,), array(UserTypePeer::ID,), $join_behavior);
