...
abstract class BaseDeliveryPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'PubName', 'PubType', 'Other', 'Color', 'Size', 'Method', 'Instructions', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'pubName', 'pubType', 'other', 'color', 'size', 'method', 'instructions', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::PUB_NAME, self::PUB_TYPE, self::OTHER, self::COLOR, self::SIZE, self::METHOD, self::INSTRUCTIONS, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'pub_name', 'pub_type', 'other', 'color', 'size', 'method', 'instructions', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'PubName' => 1, 'PubType' => 2, 'Other' => 3, 'Color' => 4, 'Size' => 5, 'Method' => 6, 'Instructions' => 7, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'pubName' => 1, 'pubType' => 2, 'other' => 3, 'color' => 4, 'size' => 5, 'method' => 6, 'instructions' => 7, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::PUB_NAME => 1, self::PUB_TYPE => 2, self::OTHER => 3, self::COLOR => 4, self::SIZE => 5, self::METHOD => 6, self::INSTRUCTIONS => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'pub_name' => 1, 'pub_type' => 2, 'other' => 3, 'color' => 4, 'size' => 5, 'method' => 6, 'instructions' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
