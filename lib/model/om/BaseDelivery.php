...
abstract class BaseDelivery extends BaseObject  implements Persistent {
  ...
  const PEER = 'DeliveryPeer';
	...
	/**
	 * The value for the pub_name field.
	 * @var        string
	 */
	protected $pub_name;
	...
	/**
	 * Set the value of [pub_name] column.
	 * 
	 * @param      string $v new value
	 * @return     Delivery The current object (for fluent API support)
	 */
	public function setPubName($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}
		...
		if ($this->pub_name !== $v) {
			$this->pub_name = $v;
			$this->modifiedColumns[] = DeliveryPeer::PUB_NAME;
		}
	...
	public function setPubType($v)
	{
		...
		if ($this->pub_type !== $v) {
			$this->pub_type = $v;
			$this->modifiedColumns[] = DeliveryPeer::PUB_TYPE;
		}
	...
	public function setOther($v)
	{
		...
		if ($this->other !== $v) {
			$this->other = $v;
			$this->modifiedColumns[] = DeliveryPeer::OTHER;
		}
	...
	public function setColor($v)
	{
		...
		if ($this->color !== $v) {
			$this->color = $v;
			$this->modifiedColumns[] = DeliveryPeer::COLOR;
		}
	...
	public function setFormat($v)
	{
		...
		if ($this->format !== $v) {
			$this->format = $v;
			$this->modifiedColumns[] = DeliveryPeer::FORMAT;
		}
	...
	public function setSize($v)
	{
		...
		if ($this->size !== $v) {
			$this->size = $v;
			$this->modifiedColumns[] = DeliveryPeer::SIZE;
		}
	...
	public function setMethod($v)
	{
		...
		if ($this->method !== $v) {
			$this->method = $v;
			$this->modifiedColumns[] = DeliveryPeer::METHOD;
		}
	...
	public function setInstructions($v)
	{
		...
		if ($this->instructions !== $v) {
			$this->instructions = $v;
			$this->modifiedColumns[] = DeliveryPeer::INSTRUCTIONS;
		}
	...
	public function setJobId($v)
	{
		...
		if ($this->job_id !== $v) {
			$this->job_id = $v;
			$this->modifiedColumns[] = DeliveryPeer::JOB_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->pub_name = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			$this->pub_type = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			$this->other = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			...
			$this->method = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
			$this->instructions = ($row[$startcol + 8] !== null) ? (string) $row[$startcol + 8] : null;
			$this->job_id = ($row[$startcol + 9] !== null) ? (int) $row[$startcol + 9] : null;
			$this->resetModified();
			...
			return $startcol + 10; // 10 = DeliveryPeer::NUM_COLUMNS - DeliveryPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[1], $arr)) $this->setPubName($arr[$keys[1]]);
		if (array_key_exists($keys[2], $arr)) $this->setPubType($arr[$keys[2]]);
		...
		if (array_key_exists($keys[8], $arr)) $this->setInstructions($arr[$keys[8]]);
		if (array_key_exists($keys[9], $arr)) $this->setJobId($arr[$keys[9]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(DeliveryPeer::PUB_NAME)) $criteria->add(DeliveryPeer::PUB_NAME, $this->pub_name);
		if ($this->isColumnModified(DeliveryPeer::PUB_TYPE)) $criteria->add(DeliveryPeer::PUB_TYPE, $this->pub_type);
		if ($this->isColumnModified(DeliveryPeer::OTHER)) $criteria->add(DeliveryPeer::OTHER, $this->other);
		if ($this->isColumnModified(DeliveryPeer::COLOR)) $criteria->add(DeliveryPeer::COLOR, $this->color);
		if ($this->isColumnModified(DeliveryPeer::FORMAT)) $criteria->add(DeliveryPeer::FORMAT, $this->format);
		if ($this->isColumnModified(DeliveryPeer::SIZE)) $criteria->add(DeliveryPeer::SIZE, $this->size);
		if ($this->isColumnModified(DeliveryPeer::METHOD)) $criteria->add(DeliveryPeer::METHOD, $this->method);
		if ($this->isColumnModified(DeliveryPeer::INSTRUCTIONS)) $criteria->add(DeliveryPeer::INSTRUCTIONS, $this->instructions);
		if ($this->isColumnModified(DeliveryPeer::JOB_ID)) $criteria->add(DeliveryPeer::JOB_ID, $this->job_id);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setPubName($this->pub_name);
		...
		$copyObj->setInstructions($this->instructions);
