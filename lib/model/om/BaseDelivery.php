  ...
  const PEER = 'DeliveryPeer';
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->instructions = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
			$this->job_id = ($row[$startcol + 8] !== null) ? (int) $row[$startcol + 8] : null;
			$this->resetModified();
			...
			return $startcol + 9; // 9 = DeliveryPeer::NUM_COLUMNS - DeliveryPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[7], $arr)) $this->setInstructions($arr[$keys[7]]);
		if (array_key_exists($keys[8], $arr)) $this->setJobId($arr[$keys[8]]);
	}
