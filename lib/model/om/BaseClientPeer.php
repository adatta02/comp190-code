...
abstract class BaseClientPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'UserId', 'Name', 'Department', 'Address', 'Email', 'Phone', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'userId', 'name', 'department', 'address', 'email', 'phone', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::USER_ID, self::NAME, self::DEPARTMENT, self::ADDRESS, self::EMAIL, self::PHONE, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'user_id', 'name', 'department', 'address', 'email', 'phone', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'UserId' => 1, 'Name' => 2, 'Department' => 3, 'Address' => 4, 'Email' => 5, 'Phone' => 6, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'userId' => 1, 'name' => 2, 'department' => 3, 'address' => 4, 'email' => 5, 'phone' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::USER_ID => 1, self::NAME => 2, self::DEPARTMENT => 3, self::ADDRESS => 4, self::EMAIL => 5, self::PHONE => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'user_id' => 1, 'name' => 2, 'department' => 3, 'address' => 4, 'email' => 5, 'phone' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	public static function doCountJoinUser(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(ClientPeer::USER_ID,), array(UserPeer::ID,), $join_behavior);
	...
	/**
	 * Selects a collection of Client objects pre-filled with their User objects.
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    foreach (sfMixer::getCallables('BaseClientPeer:doSelectJoin:doSelectJoin') as $callable)
    {
      call_user_func($callable, 'BaseClientPeer', $c, $con);
		...
		$c->addJoin(array(ClientPeer::USER_ID,), array(UserPeer::ID,), $join_behavior);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Client) to $obj2 (User)
				$obj2->addClient($obj1);
      ...
      call_user_func($callable, 'BaseClientPeer', $c, $con);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Client) to the collection in $obj2 (User)
				$obj2->addClient($obj1);
