...
abstract class BaseProjectPeer {
	...
	const STATUS_ID = 'project.STATUS_ID';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'StatusId', 'Slug', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'statusId', 'slug', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::NAME, self::STATUS_ID, self::SLUG, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'status_id', 'slug', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'StatusId' => 2, 'Slug' => 3, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'statusId' => 2, 'slug' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NAME => 1, self::STATUS_ID => 2, self::SLUG => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'status_id' => 2, 'slug' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new ProjectMapBuilder();
		}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(ProjectPeer::STATUS_ID);
    ...
    foreach (sfMixer::getCallables('BaseProjectPeer:doCount:doCount') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseProjectPeer:doSelectStmt:doSelectStmt') as $callable)
    {
      call_user_func($callable, 'BaseProjectPeer', $criteria, $con);
    }
	...
	public static function doCountJoinStatus(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(ProjectPeer::STATUS_ID,), array(StatusPeer::ID,), $join_behavior);
	...
	/**
	 * Selects a collection of Project objects pre-filled with their Status objects.
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
      ...
      call_user_func($callable, 'BaseProjectPeer', $c, $con);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Project) to $obj2 (Status)
...
//
// NOTE: This static code cannot call methods on the ProjectPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the ProjectPeer class:
//
// Propel::getDatabaseMap(ProjectPeer::DATABASE_NAME)->addTableBuilder(ProjectPeer::TABLE_NAME, ProjectPeer::getMapBuilder());
//
// Doing so will effectively overwrite the registration below.

Propel::getDatabaseMap(BaseProjectPeer::DATABASE_NAME)->addTableBuilder(BaseProjectPeer::TABLE_NAME, BaseProjectPeer::getMapBuilder());
