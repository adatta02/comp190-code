...
abstract class BasesfGuardUserProfilePeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'UserTypeId', 'UserId', 'Email', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'userTypeId', 'userId', 'email', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::USER_TYPE_ID, self::USER_ID, self::EMAIL, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'user_type_id', 'user_id', 'email', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'UserTypeId' => 1, 'UserId' => 2, 'Email' => 3, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'userTypeId' => 1, 'userId' => 2, 'email' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::USER_TYPE_ID => 1, self::USER_ID => 2, self::EMAIL => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'user_type_id' => 1, 'user_id' => 2, 'email' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
