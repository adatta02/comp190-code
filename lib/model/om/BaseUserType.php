...
abstract class BaseUserType extends BaseObject  implements Persistent {
  ...
  const PEER = 'UserTypePeer';
	...
	/**
	 * Initializes internal state of BaseUserType object.
	 * @see        applyDefaults()
	 */
	...
	public function setType($v)
	{
		...
		if ($this->type !== $v) {
			$this->type = $v;
			$this->modifiedColumns[] = UserTypePeer::TYPE;
		}
	...
	public function setPermissions($v)
	{
		...
		if ($this->permissions !== $v) {
			$this->permissions = $v;
			$this->modifiedColumns[] = UserTypePeer::PERMISSIONS;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->permissions = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
			$this->resetModified();
			...
			return $startcol + 3; // 3 = UserTypePeer::NUM_COLUMNS - UserTypePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(UserTypePeer::TYPE)) $criteria->add(UserTypePeer::TYPE, $this->type);
		if ($this->isColumnModified(UserTypePeer::PERMISSIONS)) $criteria->add(UserTypePeer::PERMISSIONS, $this->permissions);
	 ...
	 * related Users from storage. If this UserType is new, it will return
		...
		if ($this->collUsers === null) {
			if ($this->isNew()) {
			   $this->collUsers = array();
				...
				$criteria->add(UserPeer::USER_TYPE_ID, $this->id);
