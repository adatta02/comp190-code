  ...
  const PEER = 'JobPeer';
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->zip = ($row[$startcol + 13] !== null) ? (int) $row[$startcol + 13] : null;
			...
			$this->photo_type = ($row[$startcol + 19] !== null) ? (int) $row[$startcol + 19] : null;
			$this->acct_num = ($row[$startcol + 20] !== null) ? (string) $row[$startcol + 20] : null;
			$this->dept_id = ($row[$startcol + 21] !== null) ? (string) $row[$startcol + 21] : null;
			$this->grant_id = ($row[$startcol + 22] !== null) ? (string) $row[$startcol + 22] : null;
			$this->other = ($row[$startcol + 23] !== null) ? (string) $row[$startcol + 23] : null;
			...
			return $startcol + 25; // 25 = JobPeer::NUM_COLUMNS - JobPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[19] => $this->getPhotoType(),
			$keys[20] => $this->getAcctNum(),
			$keys[21] => $this->getDeptId(),
			$keys[22] => $this->getGrantId(),
			$keys[23] => $this->getOther(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[19], $arr)) $this->setPhotoType($arr[$keys[19]]);
		if (array_key_exists($keys[20], $arr)) $this->setAcctNum($arr[$keys[20]]);
		if (array_key_exists($keys[21], $arr)) $this->setDeptId($arr[$keys[21]]);
		if (array_key_exists($keys[22], $arr)) $this->setGrantId($arr[$keys[22]]);
		if (array_key_exists($keys[23], $arr)) $this->setOther($arr[$keys[23]]);
