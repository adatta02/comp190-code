...
abstract class BasePhotoPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'JobId', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'jobId', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::JOB_ID, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'job_id', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'JobId' => 1, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'jobId' => 1, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::JOB_ID => 1, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'job_id' => 1, ),
		BasePeer::TYPE_NUM => array (0, 1, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(PhotoPeer::JOB_ID);
	...
	public static function doCountJoinJob(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(PhotoPeer::JOB_ID,), array(JobPeer::ID,), $join_behavior);
	...
	/**
	 * Selects a collection of Photo objects pre-filled with their Job objects.
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    foreach (sfMixer::getCallables('BasePhotoPeer:doSelectJoin:doSelectJoin') as $callable)
    {
      call_user_func($callable, 'BasePhotoPeer', $c, $con);
		...
		$c->addJoin(array(PhotoPeer::JOB_ID,), array(JobPeer::ID,), $join_behavior);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Photo) to $obj2 (Job)
				$obj2->addPhoto($obj1);
      ...
      call_user_func($callable, 'BasePhotoPeer', $c, $con);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Photo) to the collection in $obj2 (Job)
				$obj2->addPhoto($obj1);
