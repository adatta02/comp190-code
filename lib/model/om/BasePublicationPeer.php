...
abstract class BasePublicationPeer {
	...
	const CONTACT_NAME = 'publication.CONTACT_NAME';

	/** the column name for the CONTACT_EMAIL field */
	const CONTACT_EMAIL = 'publication.CONTACT_EMAIL';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'ContactName', 'ContactEmail', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'contactName', 'contactEmail', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::NAME, self::CONTACT_NAME, self::CONTACT_EMAIL, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'contact_name', 'contact_email', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'ContactName' => 2, 'ContactEmail' => 3, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'contactName' => 2, 'contactEmail' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NAME => 1, self::CONTACT_NAME => 2, self::CONTACT_EMAIL => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'contact_name' => 2, 'contact_email' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(PublicationPeer::CONTACT_NAME);

		$criteria->addSelectColumn(PublicationPeer::CONTACT_EMAIL);
